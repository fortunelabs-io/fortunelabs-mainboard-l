...
bool spi_master_write_byte(const spi_device_handle_t SPIHandle, const uint8_t *Data,
                           size_t DataLength) {
...
void spi_display_image(SSD1306_t *dev, int page, int seg, const uint8_t *images, int width) {
    ...
    // Set Lower Column Start Address for Page Addressing Mode, Higher Column Start Address for Page
    // Addressing Mode and Page Start Address for Page Addressing Mode
