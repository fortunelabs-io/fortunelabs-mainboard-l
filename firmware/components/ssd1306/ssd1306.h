...
#define OLED_DRAW_ALL                                                                              \
    (OLED_DRAW_UPPER_RIGHT | OLED_DRAW_UPPER_LEFT | OLED_DRAW_LOWER_RIGHT | OLED_DRAW_LOWER_LEFT)
...
void spi_master_init(SSD1306_t *dev, int16_t mosi, int16_t sclk, int16_t cs, int16_t dc,
                     int16_t reset);
